...
typedef struct SelectStmt
{
	...
	/*
	 * 这些节点只会在SelectStmts "叶节点" 中使用
	 * These fields are used only in "leaf" SelectStmts.
	 */
	List	   *distinctClause; /* NULL, DISTINCT ON 表达式列表
	...
	/*
	 * 在一个表达式列表的叶节点上，上面的字段全部为 null，而这个字段会被设置。
	 ...
	 */
	List	   *valuesLists;	/* 未转换的表达式列表 untransformed list of expression lists */

	/*
	 * 这些字段会同时在 SelectStmts 叶节点与 SelectStmts 上层节点中使用
